...
<?php include"includes/navigation.php";?>
  ...
  <div id="wrapper">
    ...
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">BUY BOOK</div>
      <div class="card-body">
        <form method="post" >
  ...
  <table class="table table-bordered" id="turfs"  cellspacing="0">
              ...
              <?php
                if(isset($_POST['Search']))
                {
                   ...
                   book_info.price,book_info.id, book_info.condt, book_info.author_name FROM student_info,book_info where book_info.subject LIKE '%$subject%' AND book_info.b_year ='$year' AND book_info.branch ='$branch' AND student_info.irn_no=book_info.irn ";
